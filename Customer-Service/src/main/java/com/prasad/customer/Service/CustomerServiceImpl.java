...
//			return cus;
	...
	public ProductDto viewProductById(int id) {
		try {
			...
			ResponseEntity<ProductDto> responseEntity = restTemplate
					.getForEntity("http://localhost:8087/viewProduct/" + id, ProductDto.class);
	...
	public List<ProductDto> viewAllProducts() {
	    try {
	        ...
	        ResponseEntity<ProductDto[]> responseEntity = restTemplate.getForEntity(Product, ProductDto[].class);
